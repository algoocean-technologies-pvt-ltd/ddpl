    ...
    403: function(e, t, i) {
        ...
        class E extends f.a {
            ...
            collapse() {
                ...
                }).staggerTo(this.splitText.chars.slice(1), .4, {
                    rotationY: -70,
                    autoAlpha: 0,
                    ease: o.g.easeIn
                }, -.07, 0).to(this.line, .07 * this.splitText.chars.length + 1, {
                    x: e.left - this.lineRect.left + t,
                    ease: A.a.easeInOut
                }, 0).to(this.textElements[1], .4, {
                    opacity: 0
        ...
        class q extends s.a {
            ...
            initTitle() {
                ...
                this.title = new E({
                    element: e
                }), this.title.on("rollOver", this.onTitleRollOver.bind(this))
            }
            dispose() {
            ...
            createAnimIn(e) {
                ...
                }, "title-=" + .1 * this.title.splitText.chars.length).from(this.title.textElements[1], .6, {
                    opacity: 0
        ...
        class ae extends F {
            ...
            updateScrollHeight() {
                this.scrollHeight = this.scrollTarget.getBoundingClientRect().height, this.maxScrollY = -1 * this.scrollHeight
            }
            startRenderScroll() {
        ...
        var xe = {
                ...
                home: class extends P {
                    ...
                    onAnimateInComplete(e) {
                        super.onAnimateInComplete(e), app.skipIn && (this.element.querySelector(".home__overlay").style.visibility = "hidden")
                    }
                    onNavToggleClick(e) {
